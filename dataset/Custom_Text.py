...
class CustomText(TextDataset):
    ...
    def __init__(self, data_root, is_training=True, transform=None, ignore_list=None):
        ...
        ##
        # self.image_root = os.path.join(data_root, 'Train' if is_training else 'obj_train_data')
        self.image_root = os.path.join(data_root, 'Train' if is_training else 'sample')
        self.annotation_root = os.path.join(data_root,'Train' if is_training else 'obj_train_annotation')
